...
const Skills = () => {
  ...
  <div className="max-w-5xl mx-auto p-4">
    ...
    <p className="mt-4 text-lg text-center my-10 text-white mb-8">Writing code using languages : Java, HTML, CSS, JS, MYSQL, and Python.</p>
    ...
    <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
      ...
      <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
      <img className="w-20 mx-auto mt-4 mb-2" src={Java} alt="HTML icon" />
      ...
      <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
      <img className="w-20 mx-auto mt-4 mb-2" src={Sql} alt="HTML icon" />
